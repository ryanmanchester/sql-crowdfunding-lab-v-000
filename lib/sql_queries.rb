...
"SELECT projects.title, pledges.amount FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING pledges.amount > projects.funding_goal;"
end
